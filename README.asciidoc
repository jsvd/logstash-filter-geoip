...
ifdef::env-github[]
For common options for {type}s please check the https://www.elastic.co/guide/en/logstash/current/plugins-outputs-elasticsearch.html[documentation of logstash]
endif::[]
ifndef::env-github[]
